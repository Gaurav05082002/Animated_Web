...
export default function task() {
  useEffect(() => {
    ...
    tl.fromTo(
      ".star1",
      { duration: 1, ease: "slow", scale: 0.5, opacity: 0 },
    ...
    tl2
      .fromTo(
        ".point1",
        { x: -100, duration: 1, ease: "slow", scale: 0.5, opacity: 0 },
        { x: 0, duration: 1, ease: "smooth", scale: 1, opacity: 1 }
      )
      .fromTo(
        ".point2",
        { x: -200, duration: 1, ease: "slow", scale: 0.5, opacity: 0 },
        { x: 0, duration: 1, ease: "smooth", scale: 1, opacity: 1 }
      )
      .fromTo(
        ".point3",
        { x: -300, duration: 1, ease: "slow", scale: 0.5, opacity: 0 },
        { x: 0, duration: 1, ease: "smooth", scale: 1, opacity: 1 }
      )
      .fromTo(
        ".point4",
        { x: -400, duration: 1, ease: "slow", scale: 0.5, opacity: 0 },
        { x: 0, duration: 1, ease: "smooth", scale: 1, opacity: 1 }
      );
  }, []);
