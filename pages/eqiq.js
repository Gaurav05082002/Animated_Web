...
export default function eqiq() {
  useEffect(() => {
    ...
    tl.fromTo(
      ".avaimg",
      { x: 500, y: 30, duration: 1, ease: "elastic", scale: 0.5, rotate: 270 },
      { x: 200, y: 30, duration: 1, ease: "smooth", scale: 1, rotate: 270 }
    ).fromTo(
      ".avaimg",
      { x: 200, y: 30, duration: 1, ease: "elastic", scale: 1, rotate: 270 },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ width: "25%", padding: "10px", fontFamily: "Arial" }}>
          <p>
            ...
            back.Not having your own emotions under control might be holding you
            back
          </p>
        </div>
        <div style={{ width: "25%", padding: "10px", fontFamily: "Arial" }}>
      ...
      <div style={{ height: "60%", display: "flex", flexDirection: "column" }}>
        <div
          style={{ display: "flex", flexDirection: "row", paddingLeft: "7%" }}
        >
